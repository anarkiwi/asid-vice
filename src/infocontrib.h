...
"  Microflyte analog joystick support. And lots of other fixes and\n"
"  improvements.\n"
"\n"
...
vice_team_t core_team[] = {
    { "1999-2022", "Martin Pottendorfer", "Martin Pottendorfer <pottendo@gmx.net>" },
    { "2005-2022", "Marco van den Heuvel", "Marco van den Heuvel <blackystardust68@yahoo.com>" },
    { "2007-2022", "Fabrizio Gennari", "Fabrizio Gennari <fabrizio.ge@tiscalinet.it>" },
    { "2009-2022", "Groepaz", "Groepaz <groepaz@gmx.net>" },
    { "2009-2022", "Errol Smith", "Errol Smith <strobey@users.sourceforge.net>" },
    { "2009-2022", "Ingo Korb", "Ingo Korb <ingo@akana.de>" },
    { "2010-2022", "Olaf Seibert", "Olaf Seibert <rhialto@falu.nl>" },
    { "2011-2022", "Marcus Sutton", "Marcus Sutton <loggedoubt@gmail.com>" },
    { "2011-2022", "Kajtar Zsolt", "Kajtar Zsolt <soci@c64.rulez.org>" },
    { "2016-2022", "AreaScout", "AreaScout <areascout@gmx.at>" },
    { "2016-2022", "Bas Wassink", "Bas Wassink <b.wassink@ziggo.nl>" },
    { "2017-2022", "Michael C. Martin", "Michael C. Martin <mcmartin@gmail.com>" },
    { "2018-2022", "Christopher Phillips", "Christopher Phillips <shrydar@users.sourceforge.net>" },
    { "2019-2022", "David Hogan", "David Hogan <david.q.hogan@gmail.com>" },
    { "2020-2022", "Empathic Qubit", "Empathic Qubit <empathicqubit@entan.gl>" },
    { "2020-2022", "Roberto Muscedere", "Roberto Muscedere <cococommie@cogeco.ca>" },
    { "2021-2022", "June Tate-Gans", "June Tate-Gans <june@theonelab.com>" },
    { "2021-2022", "Pablo Roldan", "Pablo Roldan" },
    { NULL, NULL, NULL }
};
