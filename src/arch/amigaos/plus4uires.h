...
static struct TranslateNewMenu UI_MENU_NAME[] = {
  TITLE(IDMS_FILE, NULL)
    ...
    ITEM(IDMS_ATTACH_CART_IMAGE,          NULL, NULL)
      SUB(IDMS_SMART_ATTACH_IMAGE,        NULL, IDM_CART_PLUS4_SMART_ATTACH)
      SUB(IDMS_C0_LOW_IMAGE,              NULL, IDM_CART_ATTACH_C0LO)
      SUB(IDMS_C0_HIGH_IMAGE,             NULL, IDM_CART_ATTACH_C0HI)
  ...
  TITLE(IDMS_SETTINGS, NULL)
    ITEM(IDMS_PLUS4_MODEL_SETTINGS,       NULL, NULL)
      SUB(IDMS_C16_PAL,                   NULL, IDM_PLUS4_MODEL_C16_PAL)
      SUB(IDMS_C16_NTSC,                  NULL, IDM_PLUS4_MODEL_C16_NTSC)
      SUB(IDMS_PLUS4_PAL,                 NULL, IDM_PLUS4_MODEL_PLUS4_PAL)
      SUB(IDMS_PLUS4_NTSC,                NULL, IDM_PLUS4_MODEL_PLUS4_NTSC)
      SUB(IDMS_V364_NTSC,                 NULL, IDM_PLUS4_MODEL_V364_NTSC)
      SUB(IDMS_C232_NTSC,                 NULL, IDM_PLUS4_MODEL_C232_NTSC)
    ITEM(IDMS_AUTOSTART_SETTINGS,         NULL, IDM_AUTOSTART_SETTINGS)
    ITEM(IDMS_TED_VIDEO_SETTINGS,         NULL, NULL)
    ...
    ITEM(IDMS_TED_SETTINGS,               NULL, IDM_TED_SETTINGS)
    ...
    ITEM(IDMS_CART_IO_SETTINGS,           NULL, NULL)
      ...
      SUB(IDMS_V364_SPEECH_SETTINGS,      NULL, IDM_V364_SPEECH_SETTINGS)
