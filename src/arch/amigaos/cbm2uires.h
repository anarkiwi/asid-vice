...
static struct TranslateNewMenu UI_MENU_NAME[] = {
  TITLE(IDMS_FILE, NULL)
    ...
    ITEM(IDMS_ATTACH_CART_IMAGE,            NULL, NULL)
      SUB(IDMS_LOAD_CART_1XXX,              NULL, IDM_LOAD_CART_1XXX)
      SUB(IDMS_UNLOAD_CART_1XXX,            NULL, IDM_UNLOAD_CART_1XXX)
      SUB(IDMS_LOAD_CART_2_3XXX,            NULL, IDM_LOAD_CART_2_3XXX)
      SUB(IDMS_UNLOAD_CART_2_3XXX,          NULL, IDM_UNLOAD_CART_2_3XXX)
      SUB(IDMS_LOAD_CART_4_5XXX,            NULL, IDM_LOAD_CART_4_5XXX)
      SUB(IDMS_UNLOAD_CART_4_5XXX,          NULL, IDM_UNLOAD_CART_4_5XXX)
      SUB(IDMS_LOAD_CART_6_7XXX,            NULL, IDM_LOAD_CART_6_7XXX)
      SUB(IDMS_UNLOAD_CART_6_7XXX,          NULL, IDM_UNLOAD_CART_6_7XXX)
  ...
  ITEM(IDMS_MAXIMUM_SPEED,                NULL, NULL)
    ...
    ITEMTOGGLE(IDMS_VERTICAL_STRETCH,     NULL, IDM_TOGGLE_VERTICAL_STRETCH)
  ...
  TITLE(IDMS_SETTINGS, NULL)
    ITEM(IDMS_CBM2_MODEL_SETTINGS,        NULL, NULL)
      SUB(IDMS_610_PAL,                   NULL, IDM_CBM2_MODEL_610_PAL)
      SUB(IDMS_610_NTSC,                  NULL, IDM_CBM2_MODEL_610_NTSC)
      SUB(IDMS_620_PAL,                   NULL, IDM_CBM2_MODEL_620_PAL)
      SUB(IDMS_620_NTSC,                  NULL, IDM_CBM2_MODEL_620_NTSC)
      SUB(IDMS_620PLUS_PAL,               NULL, IDM_CBM2_MODEL_620PLUS_PAL)
      SUB(IDMS_620PLUS_NTSC,              NULL, IDM_CBM2_MODEL_620PLUS_NTSC)
      SUB(IDMS_710_NTSC,                  NULL, IDM_CBM2_MODEL_710_NTSC)
      SUB(IDMS_720_NTSC,                  NULL, IDM_CBM2_MODEL_720_NTSC)
      SUB(IDMS_720PLUS_NTSC,              NULL, IDM_CBM2_MODEL_720PLUS_NTSC)
    ITEM(IDMS_AUTOSTART_SETTINGS,         NULL, IDM_AUTOSTART_SETTINGS)
    ITEM(IDMS_CRTC_VIDEO_SETTINGS,        NULL, NULL)
    ...
    ITEM(IDMS_CIA_SETTINGS,               NULL, IDM_CIA_SETTINGS)
