...
#ifndef VICE_CBM5X0UIRES_H_
#define VICE_CBM5X0UIRES_H_
...
static struct TranslateNewMenu UI_MENU_NAME[] = {
  ...
  TITLE(IDMS_SETTINGS, NULL)
    ITEM(IDMS_CBM5X0_MODEL_SETTINGS,      NULL, NULL)
      SUB(IDMS_510_PAL,                   NULL, IDM_CBM2_MODEL_510_PAL)
      SUB(IDMS_510_NTSC,                  NULL, IDM_CBM2_MODEL_510_NTSC)
    ...
    ITEM(IDMS_CBM5X0_SETTINGS,            NULL, IDM_CBM5X0_SETTINGS)
