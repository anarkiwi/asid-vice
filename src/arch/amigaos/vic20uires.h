...
static struct TranslateNewMenu UI_MENU_NAME[] = {
  TITLE(IDMS_FILE, NULL)
    ...
    ITEM(IDMS_ATTACH_CART_IMAGE,      NULL, NULL)
      SUB(IDMS_GENERIC_IMAGE,         NULL, IDM_CART_VIC20_GENERIC)
      SUB(IDMS_BEHR_BONZ_IMAGE,       NULL, IDM_CART_VIC20_BEHR_BONZ)
      SUB(IDMS_MEGA_CART_IMAGE,       NULL, IDM_CART_VIC20_MEGACART)
      SUB(IDMS_FINAL_EXPANSION_IMAGE, NULL, IDM_CART_VIC20_FINAL_EXPANSION)
      SUB(IDMS_UM_IMAGE,              NULL, IDM_CART_VIC20_UM)
      SUB(IDMS_FP_IMAGE,              NULL, IDM_CART_VIC20_FP)
      ITEMSEPARATOR()
      ITEM(IDMS_ADD_TO_GENERIC,       NULL, NULL)
        SUB(IDMS_SMART_ATTACH_IMAGE,  NULL, IDM_CART_VIC20_SMART_ATTACH)
      ...
      ITEMSEPARATOR()
      SUB(IDMS_SET_CART_AS_DEFAULT,   NULL, IDM_CART_SET_DEFAULT)
      SUB(IDMS_RESET_ON_CART_CHANGE,  NULL, IDM_TOGGLE_CART_RESET)
...
#endif
    ITEMSEPARATOR()
    ITEM(IDMS_SWAP_USERPORT_JOYSTICKS,    "J",  IDM_SWAP_USERPORT_JOYSTICK)
  ...
  TITLE(IDMS_SETTINGS, NULL)
    ITEM(IDMS_VIC20_MODEL_SETTINGS,       NULL, NULL)
      SUB(IDMS_VIC20_PAL,                 NULL, IDM_VIC20_MODEL_VIC20_PAL)
      SUB(IDMS_VIC20_NTSC,                NULL, IDM_VIC20_MODEL_VIC20_NTSC)
      SUB(IDMS_VIC21,                     NULL, IDM_VIC20_MODEL_VIC21)
    ITEM(IDMS_AUTOSTART_SETTINGS,         NULL, IDM_AUTOSTART_SETTINGS)
    ITEM(IDMS_VIC_VIDEO_SETTINGS,         NULL, NULL)
    ...
    ITEM(IDMS_VIC20_SETTINGS,             NULL, IDM_VIC20_SETTINGS)
    ...
    ITEM(IDMS_CART_IO_SETTINGS,           NULL, NULL)
      ...
      SUB(IDMS_FINAL_EXPANSION_WRITEBACK, NULL, IDM_FINAL_EXPANSION_WRITEBACK)
      SUB(IDMS_FP_WRITEBACK,              NULL, IDM_FP_WRITEBACK)
      SUB(IDMS_UM_WRITEBACK,              NULL, IDM_UM_WRITEBACK)
      SUB(IDMS_MEGACART_WRITEBACK,        NULL, IDM_MEGACART_WRITEBACK)
      SUB(IDMS_MEGACART_WRITEBACK_FILE,   NULL, IDM_MEGACART_WRITEBACK_FILE)
      SUB(IDMS_IO2_RAM_ENABLE,            NULL, IDM_IO2_RAM_ENABLE)
      SUB(IDMS_IO3_RAM_ENABLE,            NULL, IDM_IO3_RAM_ENABLE)
      SUB(IDMS_VFLI_MOD_ENABLE,           NULL, IDM_VFLI_MOD_ENABLE)
    ITEMSEPARATOR()
      SUB(IDMS_ACIA_SETTINGS_MASCUERADE,        NULL, IDM_ACIA_SETTINGS)
      SUB(IDMS_DIGIMAX_SETTINGS_MASCUERADE,     NULL, IDM_DIGIMAX_SETTINGS)
      SUB(IDMS_DS12C887RTC_SETTINGS_MASCUERADE, NULL, IDM_DS12C887RTC_SETTINGS)
      SUB(IDMS_GEORAM_SETTINGS_MASCUERADE,      NULL, IDM_GEORAM_SETTINGS)
      SUB(IDMS_SFX_SE_SETTINGS_MASCUERADE,      NULL, IDM_SFX_SE_SETTINGS)
      SUB(IDMS_SFX_SS_SETTINGS_MASCUERADE,      NULL, IDM_SFX_SE_SETTINGS)
