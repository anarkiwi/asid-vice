...
static struct TranslateNewMenu UI_MENU_NAME[] = {
  ...
  TITLE(IDMS_SETTINGS, NULL)
    ITEM(IDMS_C64DTV_MODEL_SETTINGS,      NULL, NULL)
      SUB(IDMS_C64DTV2_PAL,               NULL, IDM_C64DTV_MODEL_V2_PAL)
      SUB(IDMS_C64DTV2_NTSC,              NULL, IDM_C64DTV_MODEL_V2_NTSC)
      SUB(IDMS_C64DTV3_PAL,               NULL, IDM_C64DTV_MODEL_V3_PAL)
      SUB(IDMS_C64DTV3_NTSC,              NULL, IDM_C64DTV_MODEL_V3_NTSC)
      SUB(IDMS_HUMMER_NTSC,               NULL, IDM_C64DTV_MODEL_HUMMER_NTSC)
