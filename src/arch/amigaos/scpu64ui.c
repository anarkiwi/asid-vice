...
#define UI_SCPU64
#define UI_MENU_NAME scpu64_ui_translation_menu
#define UI_TRANSLATED_MENU_NAME scpu64_ui_menu

#include "private.h"
#include "c64model.h"
#include "scpu64ui.h"
#include "scpu64uires.h"
#include "translate.h"
#include "uic64cart.h"
...
static int scpu64_ui_specific(video_canvas_t *canvas, int idm)
{
...
int scpu64ui_init(void)
{
    ...
    ui_register_menu_translation_layout(scpu64_ui_translation_menu);
    ui_register_menu_layout(scpu64_ui_menu);
