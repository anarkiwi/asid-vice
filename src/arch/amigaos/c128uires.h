...
#ifndef VICE_C128UIRES_H_
#define VICE_C128UIRES_H_
...
static struct TranslateNewMenu UI_MENU_NAME[] = {
  ...
  ITEM(IDMS_MAXIMUM_SPEED,                NULL, NULL)
    ...
    ITEM(IDMS_VDC_SETTINGS,               NULL, NULL)
      ...
      SUBTOGGLE(IDMS_VERTICAL_STRETCH,    NULL, IDM_TOGGLE_VERTICAL_STRETCH)
      SUBSEPARATOR()
      SUBTOGGLE(IDMS_64KB_VIDEO_MEMORY,   NULL, IDM_TOGGLE_VDC64KB)
    ITEM(IDMS_VDC_REVISION,               NULL, NULL)
      SUBTOGGLE(IDMS_VDC_REV_0,           NULL, IDM_VDC_REV_0)
      SUBTOGGLE(IDMS_VDC_REV_1,           NULL, IDM_VDC_REV_1)
      SUBTOGGLE(IDMS_VDC_REV_2,           NULL, IDM_VDC_REV_2)
  ...
  TITLE(IDMS_SETTINGS, NULL)
    ITEM(IDMS_C128_MODEL_SETTINGS,        NULL, NULL)
      SUB(IDMS_C128_PAL,                  NULL, IDM_C128_MODEL_C128_PAL)
      SUB(IDMS_C128DCR_PAL,               NULL, IDM_C128_MODEL_C128DCR_PAL)
      SUB(IDMS_C128_NTSC,                 NULL, IDM_C128_MODEL_C128_NTSC)
      SUB(IDMS_C128DCR_NTSC,              NULL, IDM_C128_MODEL_C128DCR_NTSC)
    ...
    ITEM(IDMS_VDC_VIDEO_SETTINGS,         NULL, NULL)
        SUBTOGGLE(IDMS_AUDIO_LEAK,        NULL, IDM_TOGGLE_AUDIO_LEAK_2)
        SUB(IDMS_PALETTE_SETTINGS,        NULL, IDM_PALETTE_SETTINGS_2)
        SUB(IDMS_COLOR_SETTINGS,          NULL, IDM_COLOR_SETTINGS_2)
        SUB(IDMS_RENDER_FILTER,           NULL, IDM_RENDER_FILTER_2)
        SUB(IDMS_CRT_EMULATION_SETTINGS,  NULL, IDM_CRT_EMULATION_SETTINGS_2)
