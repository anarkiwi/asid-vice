...
static tui_menu_item_def_t drive##num##_type_submenu[] = {                              \
    ...
    { "15_51, 5\"1/4 SS",                                                               \
      ...
      TUI_MENU_BEH_CLOSE, NULL, NULL },                                                 \
    { "157_0, 5\"1/4 SS",                                                               \
      "Emulate a 1570 5\"1/4 single-sided disk drive as unit #" #num,                   \
      radio_Drive##num##Type_callback, (void *)DRIVE_TYPE_1570, 0,                      \
      TUI_MENU_BEH_CLOSE, NULL, NULL },                                                 \
    { "15_71, 5\"1/4 DS",                                                               \
...
tui_menu_item_def_t driveplus4_drive8_settings_submenu[] = {
    { "Drive #_8 model:",
...
tui_menu_item_def_t driveplus4_drive9_settings_submenu[] = {
    { "Drive #_9 model:",
...
tui_menu_item_def_t driveplus4_drive10_settings_submenu[] = {
    { "Drive #1_0 model:",
...
tui_menu_item_def_t driveplus4_drive11_settings_submenu[] = {
    { "Drive #_11 model:",
...
tui_menu_item_def_t driveplus4_settings_submenu[] = {
    ...
    { "Drive #_8 settings:",
      "Drive #8 settings",
      NULL, NULL, 26,
      TUI_MENU_BEH_CONTINUE, driveplus4_drive8_settings_submenu,
      "Drive 8 settings" },
    { "Drive #_9 settings:",
      "Drive #9 settings",
      NULL, NULL, 26,
      TUI_MENU_BEH_CONTINUE, driveplus4_drive9_settings_submenu,
      "Drive 9 settings" },
    { "Drive #1_0 settings:",
      "Drive #10 settings",
      NULL, NULL, 26,
      TUI_MENU_BEH_CONTINUE, driveplus4_drive10_settings_submenu,
      "Drive 10 settings" },
    { "Drive #_11 settings:",
      "Drive #11 settings",
      NULL, NULL, 26,
      TUI_MENU_BEH_CONTINUE, driveplus4_drive11_settings_submenu,
      "Drive 11 settings" },
   { NULL }
};
