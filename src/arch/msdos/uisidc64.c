/*
 * uisidc64.c - C64 SID UI interface for MS-DOS.
 *
 * Written by
...
static tui_menu_item_def_t sid_stereo_address_submenu[] = {
    ...
    { "$D5xx:",
      "Stereo SID in the $D5xx range",
      sid_stereo_address_submenu_callback, NULL, 5,
      TUI_MENU_BEH_CONTINUE, sid_stereo_address_d5xx_submenu, "Stereo SID in the $D5xx range" },
    { "$D6xx:",
      "Stereo SID in the $D6xx range",
      sid_stereo_address_submenu_callback, NULL, 5,
      TUI_MENU_BEH_CONTINUE, sid_stereo_address_d6xx_submenu, "Stereo SID in the $D6xx range" },
    { "$D7xx:",
...
static tui_menu_item_def_t sid_triple_address_submenu[] = {
    ...
    { "$D5xx:",
      "Triple SID in the $D5xx range",
      sid_triple_address_submenu_callback, NULL, 5,
      TUI_MENU_BEH_CONTINUE, sid_triple_address_d5xx_submenu, "Triple SID in the $D5xx range" },
    { "$D6xx:",
      "Triple SID in the $D6xx range",
      sid_triple_address_submenu_callback, NULL, 5,
      TUI_MENU_BEH_CONTINUE, sid_triple_address_d6xx_submenu, "Triple SID in the $D6xx range" },
    { "$D7xx:",
...
void sid_c64_build_menu(void)
{
    ...
    sid_c64_ui_menu_items[1].submenu = sid_engine_model_submenu;
}
